export default [{
  ...
  },
  {
    ...
    "description": "مجموعه‌ای از چهار جلد کتاب علمی‌تخیلی که اولین جلد آن با عنوان هایپریون در سال ۱۹۸۹ منتشر شد.<br>\
      ...
      خلاصه‌ای از داستان یکی از این شش زائر را می‌توانید <a href='/siri_rebellion'>در اینجا</a> با عنوان شورش سیری بخوانید که به نظر من داستان بسیار زیبایی است. من هر چهار جلد این مجموعه را خوانده‌ام."
  },
  {
    "id": "7",
    "type": "book",
...
نکته جالب دیگر، دایره گسترده واژگان ساختگی جدید و ترکیبی است که در کتاب آمده؛ موجوداتی که در آینده وجود دارند و برای حمل‌ونقل از آنها استفاده می‌شود، غول‌ها، سربازهای جهش‌یافته، حیواناتی که از گرمای انسان تغذیه می‌کنند و غیره. از غافلگیری‌های دیگر این کتاب می‌توان به سفر در زمان و مکان اشاره کرد و مکان‌ها و کاخ‌هایی که همزمان در چند محل مختلف و دور از هم قرار دارند. خلاصه اینکه خواندنش بسیار طاقت‌فرسا و مهیج بود چون پر بود از نکات ریز که باید با دقت بررسیشان کرد. من فعلا تنها دو جلد از چهار جلد آن را خوانده‌ام، اما همین دو جلد برای اینکه متقاعد شوم خلاصه‌ای از آن‌را اینجا بنویسم کافی بود."
  ...
  },
  {
    ...
    این کتاب، حکایت آگاهی اوروگنی است که از زندگی تحت انقیاد و بردگی به خشم آمده و آغازگر فصل پنجمی می‌شود که به نظر می‌رسد این بار قرار است که بشریت را به کل نابود کند. برگردان فارسی این کتاب بدست کتابسرای تندیس چاپ شده که به نظر من ترجمه آن خوب بود. من هر سه جلد آن‌را خوانده‌ام."  
  },
  {
    "id": "25",
    "type": "book",
