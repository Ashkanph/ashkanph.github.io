...
const Triangle = props => (
    <div className="circled-triangle">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 382.365 382.365" enableBackground="new 0 0 382.365 382.365" height="13px" width="13px">
            <g>
