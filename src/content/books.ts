...
داستان و شخصیت ویک ممکن است خام و جنسیت‌زده به نظر برسد ولی از یک نوجوان در چنان دنیایی نباید انتظار زیادی داشت. من تا امروز تنها یک داستان کوتاه (<a href='https://fa.wikipedia.org/wiki/%D8%AF%D9%87%D8%A7%D9%86%DB%8C_%D9%86%D8%AF%D8%A7%D8%B1%D9%85_%D9%88_%D8%A8%D8%A7%DB%8C%D8%AF_%D8%AC%DB%8C%D8%BA_%D8%A8%DA%A9%D8%B4%D9%85' target='_blank' rel='nofollow noreferrer'>دهانی ندارم و باید فریاد کنم</a>) و این ناولای کوتاه را از کارهای هارلن الیسون خوانده‌ام. هر دو از نظر من پایان‌بندی تکان‌دهنده‌ای داشتند. همین پایان‌بندی و رابطه ویک و سگش برای متمایز دانستن این کتاب و نوشتن یک معرفی کافی بود.  کمیکی هم از روی این داستان ساخته شده که من نخوانده‌ام."
  ...
  },
  {
    ...
    دنباله‌ای برای این کتاب نوشته شده که من نخوانده‌ام ولی داستان کتاب فعلی در همین جا تمام می‌شود. داستان را می‌توان علمی‌تخیلی سخت به حساب آورد چون نویسنده به شرح جزییات علمی همه چیز پرداخته. نویسنده نتوانسته سرعت پیشرفت علوم کامپیوتری را به درستی پیش‌بینی کند که به خاطر زمان انتشارش طبیعی است.<br><br>\
      با اینکه در این کتاب اصرار دانشجوی دختر جوانی باعث کشف این ستاره شد اما افتخار آن به استاد راهنمایش رسید که او را از پژوهش درباره این ستاره باز داشته و آنرا بی‌اهمیت دانسته بود. به نظر می‌رسد که نویسنده در اینجا به نادیده گرفته شدن نقش <a href='https://en.wikipedia.org/wiki/Jocelyn_Bell_Burnell' target='_blank' rel='nofollow noreferrer'>جوسلین بل برنل</a> در کشف تپ‌اختر اشاره دارد و نیز اعطای جایزه نوبل فیزیک سال ۱۹۷۴ به استاد راهنمایش و نادیده گرفتن تلاش‌های خانم برنل.<br><br>\
