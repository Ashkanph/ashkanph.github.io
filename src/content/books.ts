export default [{
    ...
    "description": "داستان آن در آینده‌ای بسیار دور می‌گذرد. هزاران سال پیش انسان‌هایی موفق شدند سیاره‌ای را تحت اختیار خود درآورند. آن‌ها که نسل اول مهاجرین بودند با تکنولوژی‌های پیشرفته و فراتر از تصور خود همچون خدایان به جاودانگی و نامیرایی رسیدند و شهرهایی بزرگ در آسمان ساختند و نام خدایان هندو را بر خود نهادند و مردمان نسل‌های پسین را که بصورت مردمان عادی و میرا در سیاره زندگی می‌کنند به پرستش خود وادار کردند و هرکس را که بخواهند پس از مرگش بر حسب پرستش و خدماتش در کالبدهایی بهتر یا بدتر دوباره به زندگی برمی‌گردانند.<br><br>\
      در این میان، یکی از این اولین خدایان، سَم (که نام‌های دیگری همچون بودا، ماهاساماتمن، سیدارتا، خداوندگار روشنایی، دربندکشنده دیوان و غیره را هم دارد) راه دیگری در پیش می‌گیرد و دربرابر خدایان دیگر می‌ایستد و خواستار برابری تمام انسان‌ها می‌شود. او حتی در این راه برای دریافت کمک به سراغ دیوانی می‌رود که از بومیان پیشین سیاره بودند و خودش آنها را در چاهی عمیق در دل کوهی در مرکز سیاره زندانی کرده بود. متن کتاب همچون متون دین بودایی است که روایت‌های زندگی بودا و شرح سفرهای او را بیان می‌کند."
  },
  {
    "id": "2",
    "type": "book",
  ...
  },
  {
    ...
    داستان آن در آینده می‌گذرد. ایستگاهی فضایی در یک سیارک میان‌تهی کشف می‌شود که متعلق به تمدنی فرازمینی و بسیار کهن به نام Heechee است. شرکتی بین‌المللی با نام شرکت دروازه (Gateway corporation) مامور کنترل و پژوهش درباره این ایستگاه فضایی می‌شود.<br><br>\
  ...
  },
  {
    ...
    "description": "مجموعه‌ای از چهار جلد کتاب علمی‌تخیلی که اولین جلد آن با عنوان هایپریون در سال ۱۹۸۹ منتشر شد.<br>\
      ...
      در چنین فضای بلبشویی، صدها سال پیش، شاه بیلی غمگین (Sad king billy)، که پادشاهی صلح‌طلب، شاعرپیشه و هنردوست بود مجبور شد به همراه یاران و نزدیکانش از سیاره خود کوچ کند. او به سیاره هایپریون رفت که در مرز جهان مسکونی بود و دور از دسترس بسیاری دیگر. و در آنجا هنرمندان و شاعران و نویسندگانی را که رانده شده و تنها مانده بودند گرد خود جمع کرد. او نام پایتخت خود را به افتخار جان کیتس (شاعر انگلیسی)، کیتس نهاد و شهر شاعران (The Poets' City) را درست کرد. با این حال از پیش از ورود شاه بیلی غمگین و همراهانش، در شمال سیاره هایپریون ساختمان‌هایی وجود داشت که از آنها با نام گورهای زمان یاد می‌شد. مشخص نبود که متعلق به چه دوره زمانی هستند و چه کسی آنها را ساخته، اما آزمایش‌ها نشان می‌داد که این ساختمان‌ها در زمان بطور برعکس در حرکت هستند و در نتیجه احتمالا متعلق به آینده هستند. موجودی افسانه‌ای به نام شرایک نیز در این منطقه وجود داشت که او را نگهبان گورهای زمان می‌دانستند. سرانجام با کشتارهای شرایک، شهر شاعران تخلیه شد و امروزه عده‌ای پیروی کلیسای شرایک هستند و به زیارت او در گورهای زمان می‌روند. داستان این کتاب درباره شش زائری است که در گیرودار حمله انسان‌های بیگانه به سیاره هایپریون، به عنوان آخرین زائران گورهای زمان انتخاب شده‌اند. کلیسای شرایک معتقد است که پایان زمان نزدیک است و این شش زائر را به عنوان آخرین زائران گورهای زمان انتخاب کرده‌است. این شش زائر در طول سفر، داستان‌های خود را برای هم بازگو می‌کنند تا دلیل انتخاب خود را بفهمند.<br><br>\
      من هر چهار جلد این مجموعه را خوانده‌ام."
  },
  {
    "id": "7",
    "type": "book",
  ...
  },
  {
    ...
    "description": "این کتاب برخلاف دیگر کتاب‌های این صفحه، نه علمی‌تخیلی است و نه فانتزی. یک داستان عاشقانه است که اولین بار در سال ۱۹۵۴ بدست یوکیو میشیما نوشته و منتشر شد. به سختی می‌توان باور کرد که این کتاب را همان میشیمایی نوشته که ۱۲ سال بعد به همراه یارانش به پادگان توکیو حمله کرد و پس از سخنرانی درباره اهمیت استقلال ژاپن برای سربازان، با پاره کردن شکمش با شمشیر خودکشی کرد.<br><br>\
...
داستان از آنجا شروع می‌شود که شینجی برای اولین‌بار هاتسو را که پس از سال‌ها دوباره به جزیره برگشته می‌بیند. این دیدار اول با دیدارهای تصادفی دیگری همراه می‌شود و آن دو ناخودآگاه به هم دل می‌بندند. پس از مدتی، حسودی حسودان و بدگویی بددلان گل می‌کند اما روابط این دو همچنان ساده و بی‌آلایش باقی می‌ماند.<br>\
...
این کتاب، اولین جلد از سه‌گانه دیوآدم (MaddAddam) است. کتاب دوم این مجموعه، سالی که سیل آمد و کتاب سوم، دیوآدم نام دارد. در کتاب دوم به سرنوشت باغبانان خداوند و در کتاب سوم به گروه دانشمندان دیوآدم پرداخته است. من دو جلد اول این سه‌گانه را خوانده‌ام."
  },
  {
    "id": "14",
    "type": "book",
...
داستان کتاب حول جو چیپ می‌گذرد که مسئول اندازه‌گیری استعداد‌های افراد استخدامی در شرکت رانسیتر است. به نظر می‌رسد که یکی از تجار مشهور جهان آنها را بصورت ناشناس برای ماموریتی مهم در ماه استخدام کرده و یازده تن از بهترین افراد آنها را می‌خواهد. رانسیتر و چیپ در این ماموریت به همراه افراد خود می‌روند و در آنجا متوجه می‌شوند که این یک تله بوده.<br> \
فضای داستان در حس تعلیق و معماگونه‌ای روایت می‌شود و اتفاقاتی عجیب رخ می‌دهد که در پایان داستان دلیلش را می‌فهمیم."
  }, {
    "id": "15",
    "type": "book",
    "year": 1966,
...
داستان مقدمه کتاب، تکان‌دهنده است. مردمان نجیب‌زاده آنگیار که تنها در فکر شرافت و شجاعت خود هستند و گدمیارها که تکنولوژی بیگانگان را فرا گرفته‌اند. و سملی که نمی‌دانست یک شب مسافرت او با آن سفینه فضایی، بیش از سی سال (به حساب زمان سیاره‌اش) طول خواهد کشید و پس از بازگشت و دیدن قبر شوهرش دیوانه شد و درگذشت. <br> \
...
این کتاب نکات جالب و غافلگیری‌های ریز زیادی داشت که خواندنش را زیبا می‌کرد. از جمله بارزترین آنها به نحوه برخورد بوداییان مذهبی تایلند با پدیده انسان‌ها و حیوانات تغییر ژنتیکی داده‌شده می‌توان اشاره کرد. بوداییانی که معتقدند این موجودات روح ندارند و در نتیجه اذیت و آزار آنها باعث سیاه شدن کارما یا نامه اعمالشان نخواهد شد. زیباترین بخش‌های کتاب مربوط به سروانی از نیروهای پیراهن‌سفید است به نام جایدی که برخلاف بقیه همکارانش، او و نیروهای تحت امرش فاسد نبوده و رشوه نمی‌گیرند و به ببر تایلند مشهور است؛ غربت و بی‌کسی او در دنیای فاسد بانکوک و مبارزات بی‌امانش با فساد را دوست داشتم. بانکوک مقدس و فاسدی که دهه‌ها بود از سطح آب دریا پایین‌تر رفته و دیواره‌های سدی بلند با هفت پمپ عظیم و نیز تلاش‌های پیراهن‌سفیدها برای جلوگیری از ورود آب، آن‌را از غرق شدن نجات داده‌بود. این کتاب در سال ۲۰۱۰ موفق شد معتبرترین جایزه‌های علمی‌تخیلی از جمله هوگو، نبیولا و لوکس را از آن خود کند."
  ...
  },
  {
    ...
    نویسنده این کتاب، دنیس ای. تیلور، وبلاگی دارد با عنوان <a href='http://dennisetaylor.org/blog/' target='_blank' rel='nofollow noreferrer'>«گذار از یک کتاب‌خوان خشمگین به نویسنده‌ای بی‌قرار»</a> که در آن به دغدغه‌های ذهنی‌اش می‌پردازد. اولین چیزی که می‌شود فهمید این است که باب یوهانسون همان دنیس تیلور است؛ فردی منزوی،  غرق در کتاب و خوره دانش و تکنولوژی. در کتاب، هر باب جدید، شخصیتی متفاوت از باب‌های دیگر دارد اما با این حال همگی طیف علاقه‌مندی‌های مشابه‌ای دارند. همه آنها برای خود یک VR (دنیای مجازی) ساخته‌اند تا انسان بودن خود را فراموش نکنند. همگی ظاهر برنامه دستیاری خود را <a href='https://en.wikipedia.org/wiki/Admiral_Ackbar' target='_blank' rel='nofollow noreferrer'>آدمیرال اکبر (Admiral Ackbar)</a> انتخاب کرده‌اند که کاراکتری است در سریال جنگ ستارگان. با اختراع تکنولوژی SCUT برای ارتباط تقریبا همزمان، می‌توانند با وجود فاصله‌های نوری از یکدیگر بطور همزمان در جلسات شرکت کنند و درباره مسائل و مشکلات خود بحث کنند و با هم به علاقه‌مندی‌های خود بپردازند. در کل مجموعه جالب و سرگرم‌کننده‌ای است و من سه جلد آن را خوانده‌ام و از وقتی که گذاشتم راضی هستم." 
  },
  {
    "id": "21",
    "type": "book",
...
نکته جالب دیگر، دایره گسترده واژگان ساختگی جدید و ترکیبی است که در کتاب آمده؛ موجوداتی که در آینده وجود دارند و برای حمل‌ونقل از آنها استفاده می‌شود، غول‌ها، سربازهای جهش‌یافته، حیواناتی که از گرمای انسان تغذیه می‌کنند و غیره. از غافلگیری‌های دیگر این کتاب می‌توان به سفر در زمان و مکان اشاره کرد و مکان‌ها و کاخ‌هایی که همزمان در چند محل مختلف و دور از هم قرار دارند. خلاصه اینکه خواندنش بسیار طاقت‌فرسا و مهیج بود چون پر بود از نکات ریز که باید با دقت بررسیشان کرد. من فعلا تنها دو جلد از چهار جلد آن را خوانده‌ام، اما همین دو جلد برای اینکه متقاعد شوم خلاصه‌ای از آن‌را اینجا بنویسم کافی بود."
  ...
  },
  {
    ...
    "creator": "N. K. Jemisin",
    "description": "اولین جلد از مجموعه سه جلدی «زمین شکسته» که هر سه جلدش در سه سال پیاپی موفق شد جایزه هوگو برای بهترین رمان را از آن خود کند (۲۰۱۶، ۲۰۱۷ و ۲۰۱۸).<br>\
    روایت داستان از زبان ضمیر دوم شخص است. مکان آن در جهانی که معلوم نیست کجاست، در سیاره‌ای خیالی که تنها یک قاره دارد و به آن آرامش (stillness) می‌گویند.<br><br>\
    ...
    این کتاب، حکایت آگاهی اوروگنی است که از زندگی تحت انقیاد و بردگی به خشم آمده و آغازگر فصل پنجمی می‌شود که به نظر می‌رسد این بار قرار است که بشریت را به کل نابود کند. من متاسفانه برگردان فارسی سه جلدش را خوانده‌ام که مطمئنا سانسورهایی داشت."
  },
  {
    "id": "25",
    "type": "book",
    ...
    "description": "ششمین کتاب از مجموعه حلقه هاینیش که می‌توان بدون اطلاع از دیگر جلدها خواندش. اما من که چهار جلد اولش را خوانده‌ام متوجه شدم که داستانش پیش از جلد اول مجموعه رخ داده.<br>\
    ...
    پیش‌تر در همین صفحه دو کتاب دیگر از مجموعه حلقه هاینیش را معرفی کرده بودم که می‌توانید آنها را نیز نگاه کنید: <a href=\"#Rocannon's world\">دنیای روکانون (اولین کتاب مجموعه)</a> و <a href='#Planet of exile'>سیاره تبعید (دومین کتاب مجموعه)</a>."  
  },
  {
    "id": "26",
    "type": "book",
...
گذر هزاران سال در این کتاب به زیبایی روایت شده؛ مسیری در کنار صومعه که در بخش اول، روزگاری معدود سواران ایالت تکزارکانا از آن عبور می‌کردند در بخش سوم به بزرگراهی شلوغ تبدیل شده که کامیون‌های خودران و بدون راننده، شب و روز از آن می‌گذرند. و همین‌طور اثرات ماندگار نادانی بشر؛ مردمانی که به علت مواد رادیواکتیوِ رها شده از انفجارهای هسته‌ای دچار نقص‌های ظاهری هستند. و تقابل دین و سیاست، کشیش‌هایی که از دنیا کناره گرفته‌اند اما مشکلات دنیای بیرون مدام به سراغشان می‌آید. و روایت صومعه از جنگ‌های هسته‌ای هزاران سال پیش که همچون روایت‌های مسیحی عهد جدید مکتوب شده، اینکه چگونه فرمانروایان جنگ‌افزارهای اهریمنی ساختند و تا سه بار مشاوران پادشاه او را از بکارگیری آن منع کردند و چگونه شیطان رخ نمود و مشاوران و پادشاهان را فریب داد."
  ...
  },
  {
    ...
    "type": "book",
    "year": 2015,
    "imageAddress": "children_of_time.jpeg",
    "pname": "فرزندان زمان",
    "oname": "Children of time",
    "creator": "Adrian Tchaikovsky",
    "description": "داستان درباره پروژه‌ای با مدیریت دکتر آورانا کِرن است که قرار است در مدار سیاره‌ای دوردست اجرا شود. در این پروژه قرار است که میمون‌هایی را در بازه‌ای طولانی‌مدت در معرض نانوویروس‌هایی قرار دهند تا روند تکامل در آنها سریع‌تر شود. اما در هنگام افتتاح، بر اثر یک انفجار تروریستی، تمام ایستگاه مداری پروژه از بین می‌رود و تنها دکتر کرن موفق می‌شود در یک کپسول نجات زنده بماند. او در آنجا به خواب مصنوعی می‌رود ولی حوادث به گونه‌ای پیش می‌رود که کسی از زمین برای نجاتش برنمی‌گردد.<br><br>\
در عین حال مقداری از نانوویروس‌های باقی‌مانده که بر اثر انفجار ایستگاه مداری پخش شده و به سیاره رسیده‌اند باعث تکامل بسیار سریع گونه‌ای از عنکبوت‌ها می‌شوند. دکتر کرن بعد از هزاران سال از خواب مصنوعی بیدار می‌شود و بعد از اینکه متوجه تکامل عنکبوت‌ها می‌شود سعی می‌کند با آنها ارتباط برقرار کند و راهنمایشان در مسیر توسعه تکنولوژی‌های جدید شود.<br><br>\
به نظرم رسید که بخش‌های تکامل عنکبوت‌ها از داستان کتاب ‌Dragon's Egg نوشته فرانک ال. فوروارد الهام گرفته شده که در <a href=\"#Dragon's Egg\">در اینجا آنرا معرفی کرده‌ام</a>."
  },
  {
    "id": "33",
    "type": "book",
    "year": 1992,
    "imageAddress": "a_fire_upon_the_deep.jpg",
    "pname": "آتشی در اعماق",
    "oname": "A Fire Upon the Deep",
    "creator": "Vernor Vinge",
    "description": "در آینده‌ای بسیار دور، که نژادهای بیگانه بسیاری در کنار هم در کهکشان راه شیری وجود دارند، در دنیایی که سیاره‌ها با شبکه داده‌های بین‌ستاره‌ای به هم متصل‌اند، ناگهان گونه‌ای بدافزار باستانی (و بسیار قدرتمندتر از گونه‌های پیشین) ظاهر شده و ساکنان یک منظومه را نابود می‌کند. تنها یک سفینه انسان‌ها موفق به فرار می‌شود. این سفینه بصورت تصادفی در سیاره‌ای دوردست و زمین‌مانند فرود می‌آید که موجودات هوشمند ساکن آن، همچون سگ ولی با گردن‌های دراز توصیف می‌شوند که بصورت جدا نمی‌توانند هوش و درک درستی حتی برای کارهای روزمره‌شان داشته باشند و برای ادامه زندگی می‌بایست در دسته‌های چند تایی بسیار نزدیک هم زندگی کنند و از هم دور نشوند. این گروه‌ها پک نامیده می‌شوند و از طریق فکر با هم ارتباط برقرار می‌کنند بطوری که پک‌ها نمی‌توانند به پک‌های دیگر نزدیک شوند چون افکارشان قاطی می‌شود (تنها در مواقع جنگ یا جفت‌گیری نزدیک هم می‌شوند) و هر چه که چشم یک عضو می‌بیند اعضای دیگر نیز می‌بینند و اگر یکی از آنها دچار درد یا بیماری شود بقیه اعضای پک نیز همان درد را حس می‌کنند. این سیاره به تازگی (چند هزارسال پیش) عصر یخبندانش را پشت سر گذاشته و موجودات ساکن آن هنوز به عصر صنعتی‌شدن نرسیده‌اند، سلاح پیشرفته مردمانش تیر و کمان است و در آن خبری از شبکه داده‌ها و یا حتی الکتریسیته نیست.<br><br>\
    از شانس بد، آنها در منطقه‌ای دوردست در شمال سیاره فرود می‌آیند که در نزدیکی مرکز حکومت فلنسریست‌هاست. جنبشی مخوف که توسط شخصی باهوش با نام فلنسر آغاز شده که با آزمایش‌های متعدد بی‌رحمانه و شکنجه و تغییر دادن اعضای پک‌ها موفق شده نیروهایی با هوش بالاتر و شرطی‌شده برای خدمت بسازد. پس از فرود سفینه و وقتی سرنشینانش بیرون آمده‌اند مورد حمله نیروهای ارتش فلنسر قرار می‌گیرند. هر دو انسان بالغ سفینه کشته می‌شوند و پسر خردسالشان بدست فلنسریست‌ها اسیر می‌شود ولی خواهر بزرگترش را جاسوس‌ها نجات می‌دهند و به سرزمین‌های جنوبی‌تر می‌برند. داستان درباره این خواهر و برادری است که در سیاره گیر کرده‌اند.<br><br>\
  ...
  },
  {
    ...
    "type": "book",
    "year": 2006,
    "imageAddress": "blindsight.jpg",
    "pname": "کوربینی",
    "oname": "Blindsight",
    "creator": "Peter Watts",
    "description": "داستان درباره خدمه سفینه‌ای است که برای کاوش جسمی فرانپتونی به کمربند کوییپر اعزام شده‌اند که امواجی رادیویی به بیرون از منظومه شمسی می‌فرستد. کتاب با بیدار شدن خدمه پس از شش سال خواب مصنوعی آغاز می‌شود. این پنج خدمه عبارتند از سیری (راوی داستان، مفسر و مستندکننده عملیات)، زبان‌شناس تیم (که همزمان سه شخصیت دیگر هم دارد. گویا این چندشخصیتی گاهی در میان افراد سایبورگ روی می‌دهد و دیگر بیماری روانی به حساب نمی‌آید)، زیست‌شناس تیم، مسئول نظامی تیم و سرانجام فرمانده تیم که آخرین گونه زنده از شاخه‌ای از انسان‌های منقرض‌شده به نام هومو ساپینس ومپایریس است و دارای قدرت‌های هوشی و جسمی بسیار فراتر از انسان‌هاست.<br><br>\
    این افراد پس از تماس با سفینه بیگانگان و ردوبدل کردن چندین پیام در می‌یابند که این سفینه دارای خودآگاهی نیست و تنها یک ماشین است که می‌تواند پیام‌های آنها را طبق الگوهایی که از شنود زمین بدست آورده پاسخ دهد (<a href='https://fa.wikipedia.org/wiki/%D8%A7%D8%AA%D8%A7%D9%82_%DA%86%DB%8C%D9%86%DB%8C' target='_blank' rel='nofollow noreferrer'>اتاق چینی</a>). فرمانده تیم تصمیم می‌گیرد که مذاکره را رها کرده و به سفینه بیگانگان که خود را روشاخ می‌نامد وارد شوند. اما این ورود آنها را دچار عوارضی از جمله توهم کرده و ادامه ماموریت را با خطر روبه‌رو می‌کند.<br><br>\
    در حین فصل‌های کتاب، بخشی از زندگی سیری هم مرور می‌شود و می‌فهمیم که چطور عمل جراحی مغز او در کودکی باعث تغییر خصوصیات انسانی او شده و سبب شده که همه چیز را بصورت منطقی تفسیر کند؛ این تغییرات بوضوح دربخشی از کتاب که چگونگی برخورد سیری با مرگ دوست‌دخترش بیان شده به طرز تکان‌دهنده‌ای روایت شده بود.<br><br>\
    شخصیت فرمانده به نظرم جالب بود، تنها باقیمانده گونه منقرض‌شده خون‌آشام‌ها (که در کتاب چنین آمده که گویا از اول هم واقعی بوده‌اند)، او را تحت تدابیر شدید امنیتی و داروهای پزشکی به عنوان فرمانده سفینه به ماموریت فرستاده‌اند. او هوش و توانایی جسمی بالایی دارد و همه در حضورش وحشت‌زده می‌شوند و گویا یک سایکوپت است، مثل باقی افراد منقرض‌شده نژادش (به خاطر تنهایی ذاتی این گونه، هوش بالا، قدرت‌های روانی و فیزیکی بالا و شکار انسان‌ها و تغذیه از آنها). در پایان کتاب هم یک مقاله شبه‌علمی درباره گونه هومو ساپینس ومپایریس آمده که شمار زیادی رفرنس علمی واقعی دارد و این هم رویکرد جالبی بود.<br><br>\
    این کتاب با <a href='https://fa.wikipedia.org/wiki/%DA%A9%D8%B1%DB%8C%DB%8C%D8%AA%DB%8C%D9%88_%DA%A9%D8%A7%D9%85%D9%86%D8%B2' target='_blank' rel='nofollow noreferrer'>مجوز کرییتیو کامنز</a> و بصورت رایگان منتشر شده و متن زبان اصلی آن‌را میتوانید <a href='https://rifters.com/real/Blindsight.htm' target='_blank' rel='nofollow noreferrer'>از اینجا در سایت اصلی نویسنده </a> بگیرید‌. همچنین یک ادامه نیز بر این کتاب نوشته شده ولی من آنرا نخوانده‌ام. یک داستان کوتاه هم هست که آنرا هم هنوز نخوانده‌ام ولی گویا به ماجرای پدر سیری پس از رهسپاری‌اش پرداخته و اینکه چه بلایی بر سر زمین می‌آید. پدر سیری در بخش اطلاعات و امنیت ارتش کار می‌کرد و همو بود که سیری را برای این ماموریت معرفی کرد."
  },
  {
    "id": "36",
    "type": "book",
    "year": 1965,
    "imageAddress": "billthegalactichero.jpg",
    "pname": "بیل، قهرمان کهکشان",
    "oname": "Bill, the Galactic Hero",
    "creator": "Harry Harrison",
    "description": "بیل، پسری است از یک خانواده زرتشتی کشاورز، که در سیاره فیگِرینادون دوم زندگی می‌کند. در یک بعدازظهر پاییزی او در حال کار بر روی زمینشان است که سروصدای رژه یک جوخه سربازگیری و ربات‌های آن که از جاده می‌گذرند نظرش را جلب می‌کند. سرجوخه‌ای که برای ارتش عضوگیری می‌کند، با هیپنوتیزم وادارش می‌کند تا فرم استخدام را امضا کرده و پس از دوخت سریع یونیفرم توسط ربات خیاط و پوشاندنش به او، در میان شیون مادرش که دیر به صحنه رسیده با دیگر سربازانِ به‌زوراستخدام‌شده، دهکده را با مارش نظامی ترک می‌کند. این کتاب، داستان دوران خدمت او در ارتش امپراتوری است که درگیر نبردی بی‌پایان با موجوداتی مارمولک‌مانند به نام چینگر شده‌است. میلیون‌ها سرباز که به زور از جای‌جای امپراتوری عضوگیری شده‌اند و سریع آموزش می‌بینند و سریعتر از آن هم چه در حین آموزش و چه در نبرد کشته می‌شوند.<br><br>\
    داستان بیل را می‌توان طعنه‌ای به <a href='https://en.wikipedia.org/wiki/Starship_Troopers' target='_blank' rel='nofollow noreferrer'>کتاب جنگاوران اخترناو نوشته رابرت هاین‌لاین</a> دانست که تم نظامی‌گری و جنگ‌طلب هاین‌لاین را به استهزا گرفته‌است. داستان پر از جوک و صحنه‌های کمدی تراژیک است که واقعیت‌های فعلی جوامع انسان‌ها (و همینطور ایالات متحده درگیر جنگ ویتنام) را با حسی طنزگونه به نقد کشیده؛ جنگی بی‌دلیل که پایان نمی‌یابد، نظام خویشاوندسالاری امپراتوری که فرماندهی یک سفینه نظامی با هزاران خدمه را بر دوش یک کودک گذاشته، انقلابی‌های فریب‌خورده، بحران‌های زیست‌محیطی و بیگانه‌هایی که از انسان‌ها عاقل‌تر و فهمیده‌ترند. و سرانجام چرخه‌ای معیوب از تکرار بی‌پایان.<br><br>\
    برگردان فارسی سه جلد اولش را انتشارات تندیس چاپ کرده‌است. من تنها جلد اول را خوانده‌ام که آن هم به زبان اصلی بود و از کیفیت برگردان بی‌خبرم."
  },
  {
    "id": "37",
    "type": "book",
    "year": 1987,
    "imageAddress": "consider-phlebas.jpg",
    "pname": "به فلباس بیندیش",
    "oname": "Consider Phlebas",
    "creator": "Iain M. Banks",
    "description": "حکومتی به نام کالچر بر بخش زیادی از انسان‌ها (نزدیک به ۱۸ تریلیون نفر جمعیت و صدها سیاره مسکونی) حاکم است. این حکومت از نزدیک به یک دهه پیش، پس از رد درخواست‌های ایدیران‌ها، درگیر جنگی بی‌رحمانه با آنها شده‌است. جنگی که تقریبا همه، پایان آنرا با شکستِ قطعی و زودهنگام کالچر پیش‌بینی کرده‌بودند. ایدیرانی‌ها، یکی از گونه‌های موجودات هوشمندند که از چندده‌هزار سال پیش، دینی را برگزیده‌اند که بر مبنای عقلانیت و طبقه‌بندی موجودات جهان در نظام هستی است. آنها خود را ماموران جهادی مقدس می‌دانند که بر پایه آن هر موجودی باید در جای درست خود نشانده شود. آنها نبردهای بی‌شماری داشته‌اند، ده‌ها گونه هوشمند را منقرض کرده و بسیاری دیگر را با زور، در بند قوانین خود نگاه داشته‌اند.<br><br>\
    داستان از جایی شروع می‌شود که یک کارخانه اتوماتیک ساخت سفینه‌های کالچر، در آخرین لحظات پیش از نابودی به دست ایدیران‌ها، سفینه‌ای را سرهم کرده تا آخرین هوش مصنوعی‌اش (مایند) را از مهلکه فراری دهد. مایندها، اساس ساختار حکومتی کالچر را تشکیل می‌دهند، ابرکامپیوترهایی با هوش مصنوعی که احساس، عاطفه و در عین حال خرد والایی دارند و تمامی ارکان حکومتی، تولیدی و خدماتی به دست آنها اداره می‌شود. آنها غریزه حفظ بقا هم دارند و همین غریزه باعث می‌شود که مایند فراری داده‌شده، پیش از نابودی سفینه‌اش در یک تعقیب‌وگریز، معادلات فضاوزمان را به گونه‌ای بی‌سابقه در هم بشکند و به بخشی از سیاره‌ای که در نزدیکی مسیرش بوده پناه ببرد. سیاره‌ای خالی از سکنه که بدست نیروی مرموز بیگانگانی ناشناخته محافظت می‌شود و تنها یک پست دیده‌بانی چهارنفره از چنجرها در آن قرار دارد؛ گونه‌ای از انسان‌ها که می‌توانند بخش‌هایی از بدن خود را تغییر داده و ظاهرخود را تغییر دهند.<br><br>\
    اکنون، ایدیران‌ها از یک چنجر خود با نام هورزا که در بخشی از نیروهای اطلاعاتیشان مشغول به کار است می‌خواهند که در جستجوی مایند به سیاره برود و او در این راه ماجراهای گوناگونی را تجربه می‌کند.<br><br>\
    به جرات می‌توانم بگویم که این کتاب، اولین کتاب علمی‌تخیلی است که در آن آینده بسیار روشنی برای انسان‌ها دیده‌ام. حکومت کالچر یک جامعه با <a href='https://fa.wikipedia.org/wiki/%D8%A7%D9%82%D8%AA%D8%B5%D8%A7%D8%AF_%D9%BE%D8%B3%D8%A7%DA%A9%D9%85%DB%8C%D8%A7%D8%A8%DB%8C' target='_blank' rel='nofollow noreferrer'>اقتصاد پساکمیابی</a> است که در آن پولی به کار نمی‌رود و هرکس به هر آنچه از خدمات، رفاه و لذت که بخواهد دسترسی دارد. همانگونه که از نامشان برمی‌آید تنوع فرهنگی، آیینی، زیستی و نژادی در این نظام محترم شمرده شده و چه بسا تشویق می‌شود. همه چیز بر اساس تفکرات مایندها یا هوش مصنوعی‌هایی کنترل می‌شود که قادر به کنترل و پیش‌بینی تمام اتفاقات قلمروی حکومتی کالچر ( و حتی فراتر از آن) هستند و از کوچکترین امور آگاهند. مایندهایی که در عین واقع‌بین بودن، فساد و بی‌رحمی انسان‌ها در آنها جایی ندارد و حتی یکی از آموزش‌های بنیادین نیروهای اطلاعاتی و عملیاتی آنها که در قلب دشمن فعالند، بالا نگاه داشتن حس همدردیشان با نیروهای متخاصم است. و در پایان اینکه، بعد از خواندن این کتاب، کورسوی امیدی به آینده در من سوسو زد. آرزومند آینده‌ای با حکومتی این‌چنینی و از جنس هوش‌مصنوعی هستم.<br><br>\
    ...
    },
  {
    ...
    "type": "book",
    "year": 2006,
    "imageAddress": "horus-rising.jpg",
    "pname": "شورش هوروس",
    "oname": "Horus rising",
    "creator": "Dan Abnett",
    "description": "این کتاب، اولین جلد از مجموعه «ارتداد هوروس» است که بخشی از مجموعه کتابهای وارهمر ۴۰ هزار (Warhammer 40000) است.<br>\
وارهمر یک بازی مینیاتوری محبوب (با سربازان پلاستیکی یا فلزی) است که اولین بار در سال ۱۹۸۷ ساخته شده و دستورالعمل‌ها و نسخه‌های مختلف دارد. از همان زمان داستان‌های گوناگونی برای زمینه بازی‌ها طراحی شد و بیشتر از ۴۰۰ جلد بصورت رمان و بدست نویسنده‌های مختلف یا گروهی چاپ شده‌است. فقط مجموعه ارتداد هوروس که داستان شورش هوروس علیه امپراتورش است به تنهایی ۵۴ جلد دارد و من تنها دو جلد اولش را خوانده‌ام ولی با این حال یک معرفی برایش نوشته‌ام.<br><br>\
امپراتوری بین‌کهکشانی زمین از ابرسربازانی به نام آستارتِز در کنار سربازان عادی استفاده می‌کند که با تغییر ژنتیکی از جثه بزرگتر، قدرت، چابکی و طول عمر بیشتری برخوردارند (تقریبا جاودانند، مگر اینکه در جنگ بمیرند). امپراتور به مدد این سربازان و ناوگان بی‌شمارش درصدد اتحاد دوباره انسان‌ها در سراسر جهان است (انسان‌ها هزاره‌هاست که در کهکشان‌ها پخش شده‌اند و پس از نبردهای بی‌شمار و از بین رفتن قدرت‌های اولیه، جدا و بی‌خبر از یکدیگر زندگی می‌کنند).<br><br>\
هوروس، یک آستارتز و فرمانده ناوگان ۶۳ام نیروهای اکتشافی امپراتوری است و پس از بازگشت امپراتور به زمین در ۲۰۰ سال پیش، حال فرمانده کل نیروهای اکتشافی امپراتوری است که با تکنولوژی نه چندان شناخته‌شده وارپ با یکدیگر در ارتباطند.<br><br>\
امپراتور کسی بوده که علاوه بر ساخت آستارتزها (که او را پدر خود می‌دانند چون از ژن‌های او در ساختشان استفاده شده)، خرافات و ادیان را هم از بین برده و پیروی از منطق و عقلانیت را سرلوحه کار حکومتش قرار داده، اما با این حال نسبت به بیگانگان در سیاره‌های جدیدی که می‌یابند با خشونت رفتار می‌کند.<br><br>\
داستان کتاب درباره ناوگان ۶۳ام و اکتشافات و نبردهایش در طول مسیر است. اما در سیاره‌ای که در ابتدای کتاب مجبور به نبرد در آن می‌شوند اتفاقی می‌افتد که سرنوشت امپراتوری را تغییر می‌دهد. اتفاقی که سرانجام کابوس امپراتوری می‌شود؛ اینکه آستارتزهای وفادار و فرمانبردار در برابر برادران خود و در برابر امپراتوری بایستند!<br><br>\
داستان‌ها با اطناب و جزییات توضیح داده شده‌اند. می‌توان انتظار شخصیت‌های جدید و زیادی را در طول مجموعه داشت. مسئله‌ای که از آن چندان خوشم نیامد این بود که درباره تکنولوژی‌ها و علم پشت این ابرسفینه‌ها صحبت نشد و اینکه به نظرم در آینده‌ای که انسان‌ها با سفینه‌های عظیم در بین کهکشان‌ها سفر می‌کنند، نیروهای تفنگدار و نبردهای تن‌به‌تن آنقدرها هم که در این کتاب بر آن تاکید شده مهم نخواهند بود."
  },
  {
    ...
    "type": "book",
    "year": 1971,
    "imageAddress": "to-your-scattered-bodies-go.jpg",
    "pname": null,
    "oname": "To Your Scattered Bodies Go",
    "creator": "Philip José Farmer",
    "description": "این کتاب، داستان علمی‌تخیلی متفاوتی دارد. شخصیت اصلی کتاب از روی فردی واقعی به نام <a href='https://en.wikipedia.org/wiki/Richard_Francis_Burton' target='_blank' rel='nofollow noreferrer'>سر ریچارد فرانسیس برتون</a> (۱۸۲۱-۱۸۹۰) گرفته شده که جهانگرد، سرباز و زبان‌شناسی قابل در سده نوزدهم بود. در ابتدای این کتاب، برتون ۶۹ ساله در یکی از ماجراجویی‌هایش در آفریقا زخمی شده و در حال مرگ است (برتون اصلی در دنیای واقعی در اتریش و با حمله قلبی فوت کرد). پس از مرگ برای لحظاتی بیدار شده و خود را در ستونی از انسان‌های دیگر در حال سقوط از تونل عظیمی می‌بیند و دوباره بیهوش می‌شود. پس از بیدار شدن دوباره این‌بار خود را در کنار انسان‌های دیگری در کرانه سبز و خرمِ رودی پهناور می‌بیند در حالیکه همگی برهنه، بدون مو و حدود ۲۶ ساله هستند و ظرفی فلزی و استوانه‌ای در کنارشان است.<br><br>\
...
داستان درباره تلاش دوباره برتون برای ماجراجویی و کشف این دنیای جدید است. او دوباره همچون دوران زندگی‌اش در مصر، قایقی می‌سازد و سعی میکند همانطور که در زمین به دنبال سرچشمه نیل گشت در این سرزمین هم به دنبال سرچشمه رود بگردد. او در این مسیر با اقوام گوناگون و انسان‌های دوران‌های مختلف دیدار می‌کند و به کشف‌ها و پرسش‌های بی‌پاسخی درباره این دنیای آخرت می‌رسد.<br><br>\
  ...
  },
  {
    ...
    "type": "book",
    "year": 1400,
    "imageAddress": "bandeDivan.jpg",
    "pname": null,
    "oname": "بند دیوان",
    "creator": "بهزاد قدیمی",
    "pages": 352,
    "description": "موبدی بلندمرتبه که خوشی زیر دلش زده با دیوها پیمان می‌بندد تا در ازای باز کردن بند دیوان و رهانیدن آنها، جاودان شود. سال‌ها بعد از این اتفاق، دیوان گوشه‌گوشه بهیران را دچار مشکل کرده‌اند و موبد که از کار بد خود پشیمان شده، پیمانش را شکسته و در پی در بند کردن دوباره آنهاست. موبد که موبدموبدان دربار شاه نرسی است، سپاه شکست‌ناپذیر سرمدی را به فرماندهی بهرام مامور بستن بند می‌کند. سپاه سرمدی گم می‌شود و موبد از دربار و از کسوت خود بیرون می‌آید و در‌به‌در به دنبال پیدا کردن سپاه گم‌شده، بستن بند دیوان و نجات ایرانی است که به خاطر اشتباه او در حال نابودی است.<br><br>\
موبد محل بند را فراموش کرده و به دنبال نشانه‌های آن می‌گردد. او نمی‌خوابد چون در خواب دیوها می‌توانند رد او را پیدا کنند. او در راه پیدا کردن بند به جادو دست می‌زند که حرام است و گناهان زیادی مرتکب می‌شود. نویسنده سعی کرده با آوردن بخش‌های کوتاهی در پایان هر فصل کتاب، گریزهایی به زمان معاصر و آینده بزند و نشان دهد که موبد جاودان در تمامی ابعاد زمانی و دوره‌های مختلف در حال نبرد با دیوهاست. من این بخش‌های اضافی و نامربوط را دوست نداشتم. با این حال بخش قدیمی کتاب برایم دلنشین بود و امیدوارم در آینده کتابهای بیشتری درباره ایرانی که هر گوشه‌اش پر از ایده برای داستان‌های این‌چنینی است ببینم."
  },
  {
    "id": "42",
    "type": "book",
    "year": 1999,
    "imageAddress": "blaubaer.jpg",
    "pname": "سیزده‌و‌نیم زندگی کاپیتان بِلاوبِر",
    "oname": "Die 13½ Leben des Käpt’n Blaubär",
    "creator": "Walter Moers",
    "pages": 703,
    "description": "این کتاب، داستان ۱۳ مرحله مختلف از زندگی خرسی با خز آبی‌رنگ است. اولین چیزی که به یاد می‌آورد این است که بسیار کوچک بوده و در نصف پوست گردویی در آب‌های اقیانوس سرگردان بوده. دزدان دریایی کوچک (با قد حدود ده سانتی‌متر) او را پیدا می‌کنند، راه‌ورسم دریانوردی را نشانش می‌دهند تا زمانی که بزرگتر شده و دیگر به زور در کشتیشان جا می‌شود و از سر ناچاری در جزیره‌ای رهایش می‌کنند. این خرس هر بار با مشکلات جدیدی دست‌وپنجه نرم می‌کند، گاهی گرفتار ارواح خشن دریا می‌شود، گاه گرفتار موجوداتی مخوف که قصد دارند او را بخورند، گاه سرگردان در بزرگترین شهر دنیا، آتلانتیس. در جهانی که میانبرهایی به بُعدهای دیگر فضا وجود دارد و او هم چند بار در این چاله‌ها میفتد و از ابعاد دیگر سر در می‌آورد. در دنیای دیوهای ترکیب‌شده با انسان‌ها، انواع ترول‌ها و غیره.<br><br>\
نویسنده ابتدا مجموعه تلویزیونی عروسکی و انیمیشنی کاپتان بلاوبر را در آلمان برای کودکان نویسندگی کرده و بعدها این کتاب را نوشته که اولین جلد مجموعه دوازده‌جلدی زامونین است. من تنها جلد اول را خواندم و از گمنامی این کتاب با این داستان‌های هیجان‌انگیز حیرت کردم (حداقل در ایران چندان شناخته‌شده نیست).<br>\
جایی در کتاب، مسابقاتی برگزار می‌شود که به آن دوئل دروغ (یا داستان‌سرایی) گفته می‌شود و بازیکنان آن که به آنها شوالیه‌های دروغگویی می‌گویند بصورت رودررو با یکدیگر مسابقه می‌دهند و وقایع عجیبی که هیچوقت رخ نداده را بازگو می‌کنند و بر اساس شدت تشویق تماشاگران امتیاز می‌گیرند. آنقدر این کتاب پر از ایده و داستان‌های جانبی بود که وقتی به آن فصل رسیدم احساس کردم نویسنده در تمام این مدت در حال به رخ کشیدن قدرت داستان‌سراییش بود."
  },
  {
    "id": "43",
    "type": "book",
    "year": 1963,
    "imageAddress": "die-wand.jpg",
    "pname": "دیوار",
    "oname": "Die Wand",
    "creator": "Marlen Haushofer",
    "pages": 285,
    "description": "زنی میانسال به همراه دخترخاله‌اش برای آخر هفته به کلبه شکاری آنها در میان دره‌ای کوچک در کوهپایه‌های آلپ می‌رود. او را همراه برده‌اند تا هنگامی که به شکار می‌روند به کارهای کلبه رسیدگی کند. همراهانش در بعدازظهر رسیدنشان به کلبه، به دهکده می‌روند ولی غروب و حتی فردا برنمی‌گردند و او که نگرانشان شده به سمت دهکده می‌رود اما در انتهای دره متوجه می‌شود که دیواری شفاف و نامریی اطرافش را احاطه کرده و امکان بیرون رفتن ندارد. او در دره گیر افتاده و سعی می‌کند خود و حیوان‌هایش (سگ شکاری، گاوی حامله و یک گربه) را زنده نگاه دارد. او در تابستان سیب‌زمینی و لوبیا می‌کارد و علوفه و هیزم برای زمستان ذخیره می‌کند.<br><br>\
در طول کتاب نام شخصیت اصلی را نمی‌فهمیم و حتی خودش هم می‌گوید که نامش را فراموش کرده. ما در حال خواندن یادداشت‌هایی هستیم که او در بعدازظهرهای زمستان در حاشیه تقویم‌های کشاورزی برای رهایی از ترس نوشته (ترس از تنهایی و تاریکی) و خودش هم می‌نویسد که امیدی ندارد که کسی این نوشته‌ها را بخواند. داستان کتاب، علمی‌تخیلی نیست و به جز چند حدس و گمان هیچ چیز درباره دیوار و ماهیتش نمی‌فهمیم و شخصیت اصلی هم تلاشی برای فرار از محدوده دیوار نمی‌کند. او از پشت دیوار، اجساد افراد و حیوانات را دیده و می‌داند که دیوار او را از مرگی که آن سویش همه جانداران را در برگرفته محافظت می‌کند و احتمالا تنها انسان زنده باقی مانده در این سرزمین است. جایی در ابتدای کتاب از مسخره بودن رفتارش در قفل کردن در کلبه در شب‌ها می‌نویسد و می‌گوید که تنها دشمنی که در طول زندگی‌اش داشته انسان‌ها بوده‌اند که حالا دیگر نیستند. شاید این کتاب را بتوان واکنش نویسنده به زندگی پر از رنجش دانست و آرزوی فرار از آدمها و پناه بردن به دیوارهایی که او را از گزندشان در امان بدارد.<br><br>\
هاوس‌هوفر هفت سال پس از چاپ این کتاب بر اثر سرطان فوت کرد و هرچند کتاب‌هایش برایش جایزه‌هایی به ارمغان آوردند ولی آنقدر جدی گرفته نشدند که باعث شود با خیال راحت به نویسندگی بپردازد. دهه‌ها بعد از مرگش بود که کتاب دیوار او مشهور شد و مورد توجه منتقدان و جامعه عمومی اتریش و کشورهای آلمانی‌زبان قرار گرفت."
  },
  {
    "id": "44",
    "type": "book",
    "year": 2020,
    "imageAddress": "piranesi.jpg",
    "pname": "پیرانزی",
    "oname": "Piranesi",
    "creator": "Susanna Clarke",
    "pages": 272,
    "description": "داستان درباره مردی است که در ساختمانی بزرگ و به نظر بی‌پایان زندگی می‌کند. ساختمانی سه‌طبقه که طبقه بالایش در ابرها و طبقه پایینش در امواج خروشان دریا گم می‌شود. هر طبقه از سالن‌های بزرگی از سنگ مرمر ساخته‌شده که از چهار طرف با درگاه‌هایی بزرگ به یکدیگر متصلند و به شکل زنجیروار ادامه دارند. در هر سالن و در هر طبقه مجسمه‌های سنگی بزرگ ده‌هامتری بر سکو‌هایی در کناره‌های دیوارها قرار دارند که روایت‌گر موضوعات مختلفند، از فرشتگان تا آدم‌ها، شهرها، حیوانات و غیره.<br><br>\
این کتاب یادداشت‌های روزانه اوست که به زندگی در ساختمان کاملا خو گرفته و به آن احترام می‌گذارد و از جلبک‌ها و ماهی‌هایی که از دریا می‌گیرد تغذیه می‌کند. او از شخص دیگری نیز سخن می‌گوید که دو روز در هفته با او دیدار می‌کند و تنها انسان‌های ساکن این ساختمان بزرگند.<br><br>\
تقریبا تمام نیمه اول کتاب به آشنایی با ساختمان و عادات و افکار راوی می‌گذرد و خواننده با این پرسش درگیر است که اینجا کجاست و او در آن چه می‌کند. به مرور در طول کتاب مسائل بیشتری را می‌فهمیم و پرده از راز حضور او در این ساختمان اسرارآمیز برداشته می‌شود. داستان کتاب به آرامی پیش می‌رود و خواندنش آسان و خوشایند است."
  },
  {
    "id": "45",
    "type": "book",
    "year": 1379,
    "imageAddress": "asfare-kateban.jpg",
    "pname": "اسفار کاتبان",
    "creator": "ابوتراب خسروی",
    "pages": 190,
    "description": "داستان این کتاب از زبان سه راوی مختلف بیان می‌شود. راوی اصلی دانشجویی است به نام سعید بشیری که با همکلاسی‌اش برای تحقیقی مشترک در رابطه با قدیسان و اثر آنها بر جامعه، کتابی را می‌خوانند که پدرش نوشته. پدر او پیش از مرگش، دچار خلسه‌هایی می‌شده که در آنها دنیای واقعی و گذشته را همزمان تجربه می‌کرده و وقایع را از چشم شخصی به نام شیخ یحیی کندری می‌دیده که دبیر بارگاه شجاع‌الدین شاه‌منصور،‌ آخرین شاه آل‌مظفر، بوده و صدها سال از مرگش گذشته.<br><br>\
اما داستان همکلاسی او هم جالب است که مادربزرگش که یهودی معتقدی بوده ده‌ها سال پیش بعد از دیدن رویایی از بریستول انگلیس به فاریاب کرمان آمده تا نیمه گمشده بدن قدیسی به نام شِدرَک را پیدا کند و به نیمه دیگر که در آرامگاهی در اورشلیم به خاک سپرده شده برساند. با این که به مقصود خود می‌رسد اما در ایران ازدواج هم می‌کند.<br><br>\
داستان کتاب درباره روخوانی روایات شیخ یحیی و سرگذشت یافتن نیمه قدیس است و صحبت‌های این دو دانشجو و عشقی ممنوعه که میان این دو شکل می‌گیرد.<br><br>\
بخش مکاشفات شیخ یحیی و ترکیب واقعیت با گذشته و اثر آن بر زندگی خانواده بشیری به طرز حیرت‌آوری استادانه روایت شده. زبان و سبک نوشتار که همچون نوشته‌های قدیمی است هم زیباترش کرده. درباره بخش مربوط به هموطنان کلیمی احساسات متناقضی دارم. به نظرم نویسنده کتاب روی آزادی‌های نداشتهٔ این هموطنانِ رنج‌کشیده ما زیادی حساب باز کرده‌است. ولی نکته اصلی اینجاست که وقایع این کتاب تخیلی بودند (به جز درگیری تیمور گورکانی و شجاع‌الدین شاه‌منصور) و نباید سخت‌گیری کرد."
  },
  {
    "id": "46",
    "type": "book",
    "year": 1969,
    "imageAddress": "aBoyAndHisDog.jpg",
    "pname": "پسری و سگش",
    "oname": "A Boy and His Dog",
    "creator": "Harlan Ellison",
    "pages": 61,
    "description": "در دنیایی آخرالزمانی از دولت‌های ایالات متحده و کانادا تنها شهرهای زیرمینی ایزوله و روبه‌زوال باقی مانده است. خرابه‌های شهرهای باقی‌مانده بر روی زمین هم بدست گروه‌های مختلفی اداره می‌شوند که به هیچ قانونی پایبند نیستند. در این میان افرادی پراکنده و تنها هم هستند که به آنها سولو می‌گویند. شخصیت اصلی این کتاب، ویک، یک نوجوان سولو است. <br><br>\
اما ویک تنها نیست. او سگی دارد که با تله‌پاتی می‌تواند با او ارتباط برقرار کند و در ردگیری و انجام فعالیت‌هایش به او وابسته است. سگش از نسل سگ‌های ارتشی است که در دوران جنگ بر اساس دستاوردهای یک دانشمند زیست‌شناس بوجود آمدند و به همراه کماندوها در عملیات‌‌های ارتش بکار گرفته می‌شدند. <br><br>\
سگ او در یکی از پرسه زدن‌هایشان رد دختری تنها را می‌گیرد که می‌تواند طعمه آسانی برای ویک باشد. به سراغش می‌روند و دچار دردسر می‌شوند. <br><br>\
داستان و شخصیت ویک ممکن است خام و جنسیت‌زده به نظر برسد ولی از یک نوجوان در چنان دنیایی نباید انتظار زیادی داشت. من تا امروز تنها یک داستان کوتاه (<a href='https://fa.wikipedia.org/wiki/%D8%AF%D9%87%D8%A7%D9%86%DB%8C_%D9%86%D8%AF%D8%A7%D8%B1%D9%85_%D9%88_%D8%A8%D8%A7%DB%8C%D8%AF_%D8%AC%DB%8C%D8%BA_%D8%A8%DA%A9%D8%B4%D9%85' target='_blank' rel='nofollow noreferrer'>دهانی ندارم و باید فریاد کنم</a>) و این ناولای کوتاه را از کارهای هارلن الیسون خوانده‌ام. هر دو از نظر من پایان‌بندی تکان‌دهنده‌ای داشتند. همین پایان‌بندی و رابطه ویک و سگش برای متمایز دانستن این کتاب و نوشتن یک معرفی کافی بود.  کمیکی هم از روی این داستان ساخته شده که من نخوانده‌ام."
  },
  {
    "id": "47",
    "type": "book",
    "year": 1995,
    "imageAddress": "iWhoHaveNeverKnownMen.jpg",
    "pname": "من که هرگز مردی را نشناخته‌ام",
    "oname": "Moi qui n'ai pas connu les hommes",
    "creator": "Jacqueline Harpman",
    "pages": 208,
    "description": "راوی این کتاب، دختری نوجوان است که به همراه ۳۹ زن دیگر درون قفسی در سالنی بدون پنجره زندانی شده‌اند. آنها بیشتر از ده سال است که زندانی‌اند بدون اینکه بدانند چرا و چگونه سر از اینجا درآورده‌اند و تنها خاطراتی دور و مبهم از زندگی گذشته‌شان به خاطر دارند. آنها حق ندارند یکدیگر را لمس کنند یا حتی برای لحظه‌ای از چشم سه زندانبانی که همیشه در اطراف قفس راه می‌روند پنهان بمانند. زندانبانان هیچگاه یک کلمه حرف نزده‌اند و در هنگام خاموشی نیز با دقت همگی را زیر نظر دارند و هرگونه تخطی از قوانین نانوشته‌شان با شلاق روبه‌رو می‌شود و زن‌ها در طول سال‌ها یاد گرفته‌اند آنها را نادیده بگیرند و در عین حال به شدت مراقب رفتار خود باشند.<br><br>\
    راوی، بسیاری از حرف‌ها و شوخی‌های زنهای دیگر را نمی‌فهمد. او زندگی عادی نداشته و در این قفس منزوی و تنها بار آمده ولی ذهنی قوی و مستعد یادگیری دارد.<br><br>\
    زندگی این زنان اسیر با اتفاقی ناگهانی تغییر می‌کند. کتاب از تنهایی انسان‌ها می‌گوید و خشونتی که می‌توانند در حق همنوع خود کنند. پیشینه یهودی نویسنده و تجربه‌های تلخ زندگی در طول جنگ جهانی دوم در نوشتن این کتاب بی‌تاثیر نبوده است."
  },
  {
    "id": "48",
    "type": "book",
    "year": 1980,
    "imageAddress": "dragonsEgg.jpg",
    "oname": "Dragon's Egg",
    "creator": "Robert L. Forward",
    "pages": 352,
    "description": "در سال ۲۰۲۰، یک دانشجوی دکترای اخترشناسی در دانشگاهی در آمریکا بطور اتفاقی ستاره‌ای نوترونی با قطر حدود بیست کیلومتر را در نزدیکی منظومه شمسی کشف می‌کند و سی سال بعد، سفینه‌ای برای تحقیق درباره آن به مدار این ستاره فرستاده می‌شود. برخلاف انتظار خدمه، موجوداتی هوشمند در این ستاره نوترونی زندگی می‌کنند و داستان کتاب، شرح پیشرفت تدریجی این موجودات و سپس تماس با انسان‌هاست.<br><br>\
    این کتاب روایتی زیبا از تماس انسان‌ها با این بیگانگان است. بیگانگانی که در شرایطی غیرقابل انتظار در جاذبه شصت‌وهفت‌میلیارد جی و دمای سطحی هشت هزار درجه زندگی می‌کنند. برخورد اول، برخلاف کلیشه‌های معمول نه در زمین که در محل زندگی بیگانگان و آن هم نه در سیاره بلکه در ستاره‌شان رخ می‌دهد. بیگانگانی که نه تنها قصد جنگ و دشمنی با انسان‌ها را ندارند بلکه با ظهور نور مدارگردها و سفینه‌شان، آنرا به عنوان نوری مقدس در نظر گرفته و رو به آن دعا می‌خوانند. ویژگی‌های زیستی و جامعه این موجودات هم به زیبایی شرح داده شده.<br><br>\
    دنباله‌ای برای این کتاب نوشته شده که من نخوانده‌ام ولی داستان کتاب فعلی در همین جا تمام می‌شود. داستان را می‌توان علمی‌تخیلی سخت به حساب آورد چون نویسنده به شرح جزییات علمی همه چیز پرداخته. نویسنده نتوانسته سرعت پیشرفت علوم کامپیوتری را به درستی پیش‌بینی کند که به خاطر زمان انتشارش طبیعی است.<br><br>\
      با اینکه در این کتاب اصرار دانشجوی دختر جوانی باعث کشف این ستاره شد اما افتخار آن به استاد راهنمایش رسید که او را از پژوهش درباره این ستاره باز داشته و آنرا بی‌اهمیت دانسته بود. به نظر می‌رسد که نویسنده در اینجا به کشف تپ‌اختر اشاره دارد و نیز اعطای جایزه نوبل فیزیک سال ۱۹۷۴ به استاد راهنمای خانم <a href='https://en.wikipedia.org/wiki/Jocelyn_Bell_Burnell' target='_blank' rel='nofollow noreferrer'>جوسلین بل برنل</a> و نادیده گرفته شدن تلاش‌های او در این باره.<br><br>\
متوجه شباهت‌هایش با کتاب <a href='#Children%20of%20time'>فرزندان زمان نوشته آدریان چایکوفسکی</a> شدم که با توجه به زمان انتشارشان شاید بتوان نتیجه گرفت که چایکوفسکی ایده اصلی کتابش را از همین کتاب گرفته است."
  },
//   {
//     "id": "49",
//     "type": "book",
//     "year": 2024,
//     "imageAddress": "leLongDesRuines.jpg",
//     "pname": "در امتداد ویرانه‌ها",
//     "oname": "Le long des ruines",
//     "creator": "Jérémy Perrodeau",
//     "pages": 232,
// "description": "این یک کتاب کمیک است. در اول کتاب یک شهر شلوغ و پیشرفته را در آینده می‌بینیم و رباتی که از طرف یک خانواده ثروتمند برای استقبال از یک مرد به ایستگاه قطار آمده تا او را به نزد صاحبانش ببرد. دختر این خانواده چندین سال است که در کما رفته و متخصصان از او قطع امید کرده‌اند. اما این مرد دستگاهی اختراع کرده که می‌تواند با کمک آن به دنیای ذهنی بیمار وارد شود و  او را پیدا کرده و به دنیای واقعی برگرداند. دنیای ذهن این دختر به خرابه‌ای تبدیل شده و ساکنانش در جنگ و درگیری‌های دائمی به سر می‌برند.<br><br>\
// نسخه‌ای که من خواندم از روی ویرایش سال ۲۰۲۴ کتاب بود. داستان ساده‌ای دارد و غافلگیری خاصی در آن نیست. اما با وجود نقاشی‌های ساده‌اش، مفاهیم و حتی حالات روحی شخصیت‌ها با کمک متن به خوبی منتقل شده‌اند. مثلا کم‌حرفی ساموئل، شخصیت اصلی و یا تغییر آنیا، خواهر دختر به‌کمارفته در طول کتاب حتی در طراحی‌ها هم مشخص است.<br><br>\
// قدرت نویسنده را در به تصویر کشیدن ذهنی این داستان با این دقت و در این سبک دوست داشتم. چندین تصویر از نقاشی‌های کتاب را می‌توانید در <a href='https://www.jeremyperrodeau.com/wip/lelongdesruines/' target='_blank' rel='nofollow noreferrer'>برگه‌اش در وبسایت نویسنده</a> ببینید. کتاب کمیک دیگری با نام غروب (Crépuscule) هم از این نویسنده خوانده‌ام که سبک نقاشی کاملا یکسانی دارد با داستان علمی‌تخیلی پیچیده‌تری."
// },
{
  "id": "49",
  "type": "book",
  "year": 2021,
  "imageAddress": "shangri-la.jpg",
  "oname": "Shangri-La",
  "creator": "Mathieu Bablet",
  "pages": 224,
  "gallery": [
    {
      "address": "shangri-la-2.jpg",
      "alt": "شخصیت John که انیمویدی رنج‌کشیده بود"
    }
  ],
  "description": "این یک کتاب کمیک علمی‌تخیلی تک‌جلدی است. زمین آلوده شده و هوای آن دیگر قابل تنفس نیست و انسان‌های باقیمانده در ایستگاه مداری بزرگ تیانژو که تحت شرکتی به همین نام اداره می‌شود زندگی می‌کنند. شرکتی که با مصرف‌گرایی شدید در این محیط متراکم و کوچک توانسته مردم را کنترل کند (که البته از دید من در ابتدا منطقی به نظر نمی‌رسید).<br><br>\
دانشمندانی هم وجود دارند که پروژه‌های مستقل علمی خود را پی‌گیری می‌کنند و از پروژه‌های قبلی آنها ترکیب حیوانات پستاندار کوچک با انسان‌هاست که با نام انیموید شناخته می‌شوند؛ سگ‌ها، گربه‌ها، روباه‌ها و دیگر حیواناتی که همچون انسان‌ها بر روی دو پا راه می‌روند، سخن می‌گویند و در ایستگاه زندگی و کار می‌کنند. این انیمویدها بطور گسترده مورد تبعیض و بدرفتاری قرار می‌گیرند. دانشمندان در پروژه‌ای جدید در حال ساخت نژاد جدیدی از انسان‌ها هستند تا در قمر تایتان که زمینی‌سازی آن رو به پایان است مستقر شوند.<br><br>\
داستان درباره جوانی است که از طرف رهبری شرکت برای تحقیق درباره علت انفجارهایی که اخیرا در بعضی بخش‌های ایستگاه رخ داده منصوب شده. او در این مسیر حقایقی پنهان را کشف می‌کند که انتشار آنها می‌تواند ایستگاه تیانژو را به آشوب بکشاند.<br><br>\
کتاب تا یک‌چهارم پایانیش ممکن است ترکیبی از سخنرانی‌های خام به نظر بیاید ولی من از پایان‌بندی و دیدگاه نویسنده نسبت به آینده بشریت خوشم آمد. همچنین بسیاری از صحنه‌های کتاب را نمادین یافتم،‌ از رفتار مردم نسبت به انیمویدها که نمادی از رابطه انسان امروزی با طبیعت است تا صحنه‌های آشوبی که به نوعی تاریخ هزاران ساله بشر را به یاد می‌آورد. این کتاب روایت ظلمی افسارگسیخته است که یقه ظالم و مظلوم، هر دو را می‌گیرد.<br><br>\
نویسنده در طراحی چهره‌ها به خوبی عمل نکرده و احساس افراد در چهره‌شان چندان مشخص نبود. حتی گاهی شخصیت‌ها را نمی‌شد از روی چهره‌شان متمایز کرد. نیمه دوم کتاب به اقتضای داستان دارای تصاویر خشونت‌بار است."
},
{
  "id": "50",
  "type": "book",
  "year": 2020,
  "imageAddress": "prinzGigahertz.jpg",
  "oname": "Prinz Gigahertz",
  "creator": "Lukas Kummer",
  "pages": 120,
  "description": "این یک کمیک علمی‌تخیلی است. در اول کتاب مردی را می‌بینیم که تازه از بیهوشی درآمده آن هم در دنیایی بیابانی که قحطی و بیماری‌های ناشی از رادیواکتیو همه را درگیر کرده. کمی جلوتر می‌فهمیم که او زمانی جادوگر دربار و بعدها فرمانده ارتش مقاومت پادشاهی بوده.<br><br>\
دنیایی که داستان در آن اتفاق می‌افتد دنیایی قرون وسطاییست که پادشاه و شوالیه‌هاش بر سرزمین حکم‌رانی می‌کرده‌اند اما پرتالی به این دنیا باز شده و اتفاقاتی رخ داده که باعث شده به حال و روز فعلی بیفتد. داستان بصورت فلش‌بک‌هایی به سی سال پیش روایت می‌شود و حوادثی که باعث فجایع طبیعی امروز و سقوط پادشاهی شده و همینطور کشمکش‌های زمان حال این مرد برای زنده ماندن و فرار از دست موجودی که او را تعقیب می‌کند.<br><br>\
نقاشی‌ها بسیار ساده و با رنگ‌های گیرا کشیده شده، داستانش و شخصیت‌ها برای من جذاب بود و گیر منطقی خاصی در داستان ندیدم. جلد دومی هم دارد که من نخوانده‌ام ولی داستان در همین جلد هم تمام می‌شود."
},
{
  "id": "51",
  "type": "book",
  "year": 2011,
  "imageAddress": "aShortStayInHell.jpg",
  "pname": "اقامتی کوتاه در دوزخ",
  "oname": "A Short Stay in Hell",
  "creator": "Steven L. Peck",
  "pages": 108,
  "description": "کتاب از یکی از دفاتر اداری جهنم شروع می‌شود. اتاقی با پنجره‌ای مشرف به دریاچه‌ای از گدازه‌ها و انسان‌هایی که در آن از درد ضجه می‌زنند. و شیطانی که پشت میز نشسته و پنج آدم تازه درگذشته که خود را روی صندلی‌هایی روبه‌روی او یافته‌اند و از دیدن منظره پنجره نفسشان در سینه حبس شده.<br>\
  یکی از آنها که مسیحی دینداری است دچار وحشت شده و با فریاد می‌گوید که اشتباهی رخ داده ولی شیطان توضیح می‌دهد که دینی که برگزیده‌ اشتباهی بوده و دین درست، آیین زرتشتی است و تمام غیرزرتشتیان مستقیم به جهنم فرستاده می‌شوند. او با بررسی جزیی کارنامه اعمال هر کدام، آنها را به جهنم‌های جداگانه و ویژه می‌فرستد. البته به آنها اطمینان می‌دهد که دوزخ اهورامزدا همچون جهنم ادیان دیگر دائمی نیست و اعتراف می‌کند که افراد منظره پشت پنجره بازیگرند و این نمایش را برای این برپا کرده‌اند تا ورودی‌های جدید جدیت قضیه را درک کنند.<br>\
  دیو پس از بررسی پرونده شخصیت اصلی کتاب که مرد مورمون خانواده‌دوستی‌ست و دیدن اینکه او به کتاب و کتاب‌خوانی علاقه دارد تصمیم خود را گرفته و او را به جهنم کتابخانه بابل می‌فرستد.<br>\
  این جهنم بر اساس داستانی به همین نام از خورخه لوییس بورخس، نویسنده آرژانتینی ساخته شده و در آن تمام کتاب‌هایی که می‌توان در ۴۱۰ صفحه با تمام جایگشت‌های ممکن حروف الفبا و کاراکترهای مختلف نوشت وجود دارد. این کتابخانه عظیم از طبقات بسیار زیاد و قفسه‌های بی‌شمار تشکیل شده و اهالی این دوزخ که همه همزمان در صدها هزار از طبقات میانی ظاهر شده‌اند باید کتاب شرح زندگی خود را پیدا کنند تا بتوانند به بهشت جاودان وارد شوند.<br><br>\
  بعضی این کتاب را کتابی ترسناک دانسته‌اند اما من این جهنم را جای جالبی برای یک زندگی آرام و به دور از بقیه یافتم؛ هرچند که اهالی آن سردرگم و پریشان بودند.<br><br>\
  نویسنده این کتاب فردی به شدت معتقد و مبلغ کلیسای مورمون است و یا آیین زرتشتی را تصادفی و ندانسته انتخاب کرده یا اینکه آن را برای طعنه به هات ۷۲ام یسنا (از اوستا) انتخاب کرده که می‌گوید «راه یکی است و آن راه راستی است و همه دیگر راه‌ها بیراهه‌اند». با این حال حتی تصور اینکه یگانه دین راستین باشد هم برای من دلپذیر بود."
},
];
