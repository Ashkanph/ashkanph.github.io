...
داستان از آنجا شروع می‌شود که شینجی برای اولین‌بار هاتسو را که پس از سال‌ها دوباره به جزیره برگشته می‌بیند. این دیدار اول با دیدارهای تصادفی دیگری همراه می‌شود و آن دو ناخودآگاه به هم دل می‌بندند. پس از مدتی، حسودی حسودان و بدگویی دیگران گل می‌کند اما روابط این دو همچنان ساده و بی‌آلایش باقی می‌ماند.<br>\
  ...
  "gallery": [
    {
      ...
      "alt": "شخصیت John که انیمویدی رنج‌دیده بود"
    }
  ],
