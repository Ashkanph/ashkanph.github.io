...
دانشمندانی هم وجود دارند که پروژه‌های مستقل علمی خود را پی‌گیری می‌کنند و از پروژه‌های قبلی آنها ترکیب حیوانات پستاندار کوچک با انسان‌هاست که با نام انیموید شناخته می‌شوند؛ سگ‌ها، گربه‌ها، روباه‌ها و دیگر حیواناتی که همچون انسان‌ها بر روی دو پا راه می‌روند، سخن می‌گویند و در ایستگاه زندگی و کار می‌کنند. این انیمویدها بطور گسترده مورد تبعیض و بدرفتاری قرار می‌گیرند. دانشمندان در پروژه‌ای جدید در حال ساخت نژاد جدیدی از انسان‌ها هستند تا در قمر تایتان که زمینی‌سازی آن رو به پایان است مستقر شوند و در راه ساخت این نژاد جدید، آزمایش‌هایی انجام می‌دهند که انفجاراتی را در پی دارد که می‌تواند کل ایستگاه را به خطر بیاندازد.<br><br>\
داستان درباره جوانی است که از طرف رهبری شرکت برای تحقیق درباره علت این انفجارها و متوقف کردنشان منصوب شده. او در این مسیر حقایقی پنهان را کشف می‌کند که انتشار آنها می‌تواند ایستگاه تیانژو را به آشوب بکشاند.<br><br>\
کتاب را تا یک‌چهارم پایانیش ملغمه‌ای از تصاویر نامربوط و سخنرانی‌های خام احساسی دیدم ولی بعد از آن تازه متوجه بازی ظریف نویسنده در این مدت شدم. بسیاری از صحنه‌های کتاب نمادین هستند. این کتاب روایت ظلمی افسارگسیخته است که یقه ظالم و مظلوم، هر دو را می‌گیرد.<br><br>\
